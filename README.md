...
# Maintenance
* 20-11-20 ログインフォームに表記ミス
* 20-11-20 スマホでも使いやすいように設計したが、スマホ(Safari)での使用時のみ予約ボタンに問題あり  
...
* Book
  ...
  * 日報ボタンをクリックすることで登録された情報をもとに運転日報が生成されます. 実行するサーバ環境によってはWeasyPrintが正しく動作しません.
* Car管理
